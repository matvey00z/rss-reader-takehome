...
if __name__ == '__main__':
    ...
    parser.add_argument('--dbhost', type=str, help='Postgres server hostname or IP address', required=True)
    parser.add_argument('--dbport', type=int, help='Postgres server port', required=True)
    parser.add_argument('--dbuser', type=str, help='Postgres user', required=True)
    parser.add_argument('--dbpassword', type=str, help='Postgres password', required=True)
